...
import { validarExistenciaRelacionados, validarRangoFechas, verificarExistenciaCurso } from '../validations/validaciones-cursos';
...
export class ValidacionesCursosPipe extends PrismaClient implements PipeTransform  {
  ...
  async transform(value: CreateCursoDto | UpdateCursoDto) {
    ...
    await validarRangoFechas(value.fechaInicio, value.fechaFinalizacion);
