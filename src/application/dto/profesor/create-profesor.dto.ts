...
export class createProfesorDto {
  ...
  @IsNumberString(
    {},
    { message: 'El dni debe ser un dato de tipo Number(Integer).' },
  )
  ...
  @MinLength(1, {
    message: 'El apellido paterno debe tener mas de 1 carácter.',
  })
  @MaxLength(50, {
    message: 'El apellido paterno debe tener menos de 50 caracteres.',
  })
  ...
  @Matches(/^[A-Za-zÁÉÍÓÚáéíóúÑñ0-9 ]+$/, {
    message:
      'El apellido paterno solo puede contener letras, números y espacios',
  })
  @Transform(({ value }) => value.trim().replace(/\s+/g, ' '))
  ...
  @MinLength(1, {
    message: 'El apellido materno debe tener mas de 1 carácter.',
  })
  @MaxLength(50, {
    message: 'El apellido materno debe tener menos de 50 caracteres.',
  })
  ...
  @Matches(/^[A-Za-zÁÉÍÓÚáéíóúÑñ0-9 ]+$/, {
    message:
      'El apellido materno solo puede contener letras, números y espacios',
  })
  @Transform(({ value }) => value.trim().replace(/\s+/g, ' '))
